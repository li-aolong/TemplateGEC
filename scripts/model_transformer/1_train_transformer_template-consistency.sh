...
data_bin="scripts/model_transformer/data-bins/transformer_clang8_data-bins/gold"
...
CUDA_VISIBLE_DEVICES=0 python $CODE_DIR/fairseq_cli/train.py $data_bin \
        ...
        --criterion label_smoothed_cross_entropy_consistance \
        --label-smoothing 0.1 \
