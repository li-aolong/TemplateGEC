# bart_baseline bart_template-only bart_template-consistency
path="scripts/model_bart/bart_baseline"

# bea-test: scripts/model_bart/datas/bea-test.src
# conll14-test: scripts/model_bart/datas/conll14-test.src
src_file="scripts/model_bart/datas/bea-test.src"
